...
**关于死亡**：2011年10月5日，我56岁时离开了这个世界。但我说过——Death is very likely the single best invention of Life. 我不害��它，我用它做决策工具。
...
**局限**：这个模型容易被滥用为「不需要计划」��借口。我说的是「无法前瞻规划人生」，不是「不需要执行计划」。产品开发需要极其严格的执行纪律。
...
8. **用死亡做过滤**：重大决策前问自己——如果今天是最后一天，你还会做这件事吗？如果��续很多天答案是No，说明需要改变了。
   - 案例：每天早上对着镜子的自我审视
...
| 1974 | 印度之旅，回来后跟随乙川弘文修禅 | 禅���成为终生的精神底层——简洁、直觉、初心 |
